...
@interface CGXTitleFourViewController ()<CGXCategoryViewDelegate>
{
...
@implementation CGXTitleFourViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    self.navigationItem.title = @"BackgroundView";
