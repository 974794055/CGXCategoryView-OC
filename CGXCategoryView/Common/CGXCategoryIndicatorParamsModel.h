 ...
 */
@interface CGXCategoryIndicatorParamsModel : NSObject
...
@property (nonatomic, assign) CGXCategoryCellSelectedType selectedType;  //cell被选中类型


@property (nonatomic, assign) CGXCategoryCellClickedPosition clickedPosition;
@end
