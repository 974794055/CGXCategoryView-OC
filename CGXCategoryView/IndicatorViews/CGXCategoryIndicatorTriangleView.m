//
//  CGXCategoryIndicatorTriangleView.m
//  CGXCategoryView-OC
//
...
#import "CGXCategoryIndicatorTriangleView.h"
#import "CGXCategoryFactory.h"

@interface CGXCategoryIndicatorTriangleView ()
...
- (void)reloadRefreshState:(CGXCategoryIndicatorParamsModel *)model {
    ...
    if (self.componentPosition == CGXCategoryComponentPosition_Bottom) {
